...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
                            ...
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">                                        
                                        ...
                                        <li class="nav-item">
                                            <a href="speaker.php" class="nav-link active">Speaker</a>
                                        </li>
                                        <li class="nav-item">
    ...
    <!--speakers page start-->
    <div class="team-member-sec px-120">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="row gy-4">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-speaker-wrap">
                                <div class="imgs">
                                    <img src="img/speaker-06.jpg" alt="">
                                    <ul>
                                        <li class="p-m"><i class="fa-solid fa-plus"></i></li>
                                        <li>
                                            <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-speaker-wrap">
                                <div class="imgs">
                                    <img src="img/speaker-07.jpg" alt="">
                                    <ul>
                                        <li class="p-m"><i class="fa-solid fa-plus"></i></li>
                                        <li>
                                            <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="single-speaker-wrap">
                                <div class="imgs">
                                    <img src="img/speaker-08.jpg" alt="">
                                    <ul>
                                        <li class="p-m"><i class="fa-solid fa-plus"></i></li>
                                        <li>
                                            <a href="#"><i class="fa-brands fa-facebook-f"></i></a>
