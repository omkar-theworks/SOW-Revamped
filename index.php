...
<section class="game-section">
 ...
 -->
                ...
                <div class="col-lg-6">
                    <div class="right-content-about">
                        <div class="sec-title">
                            ...
                            <h2>Brief about CSR + Awards</h2>
                            <p>This year, at WV Connect 2024, we are proud to announce a heartfelt initiative to help find companionship and support those who have lost their life partners during challenging times, such as the pandemic or in service to our nation in the army.</p>
    ...
    <section class="Partial">
        <div class="sec-title text-white text-center">
            <h2>Past Associations</h2>
        </div>
        <div class="slider">
            <div class="slide-track">
                <div class="slide">
                    <img src="img/Brand/1.jpeg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/2.jpeg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/3.jpg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/4.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/5.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/6.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/7.jpg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/8.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/9.jpg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/10.png" height="100" width="250" alt="" />
                </div>
                <!-- <div class="slide">
                    <img src="img/Brand/11.png" height="100" width="250" alt="" />
                </div> -->
                <div class="slide">
                    <img src="img/Brand/12.jpeg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/14.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/15.png" height="100" width="250" alt="" />
                </div>
                <div class="slide">
                    <img src="img/Brand/16.jpg" height="100" width="250" alt="" />
                </div>
                <div class="slide">
    ...
    <!-- FAQ Accordian -->
    <section class="FAQ-sec px-120" style="  padding-left: 60px; padding-right: 60px;">
        <!-- FAQ Accordian -->
        <div class="sec-title text-white text-center">
