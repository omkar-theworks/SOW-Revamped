...
<body data-spy="scroll" data-target=".navbar" data-offset="60">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    <a href="#" class="nav-link active"> Pages <i class="fa-solid fa-chevron-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">                                        
                                        <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a href="speaker-details.php" class="nav-link active">Speaker Details</a>
                                        </li>
                                        <li class="nav-item">
    ...
    <!--speakers details page start-->
    <section class="speaker-details-pg px-120">
        <div class="container">
            <div class="row gy-5">
                <div class="col-md-5 col-lg-4">
                    <div class="left-sidebar-spker-dt">
                        <div class="imgs">
                        ...
                        <div class="d-nm">
                            <h3>Personal Info</h3>
                            <p>Phone: + (123) 1800-567<br>
                                Office: + (123) 1800-567<br>
                                E-mail: ennevent@tlprt.com</p>
                        </div>
                        <div class="d-social">
                            <h3>follow Me Social</h3>
                            <ul class="social">
                        ...
                        <div class="cont-btn">
                            <a href="contact.php" class="btn btn1">Contact Us</a>
                        </div>
                    </div><!--/.left-sidebar-spker-dt-->
                </div>
                <div class="col-md-7 col-lg-8">
                    <div class="right-content-spkrDetails">
                        <h2>About Robert C. Simmons</h2>
                        <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some a
                            by injected humour, or randomised words which don't look even slightl believable. If you are going to use a passages
                            Lorem Ipsum, you need to be sure there isn't anything embarrassing hidden in the middle of text. All the Lorem Ipsu
                            generators on the Internet tend to repeat predefined</p>                           
                        <p>Chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin word
                            combined with a handful of model sentence structures, to generate Lorem Ipsum which looks.</p>
                        <hr>
                        <div class="row gy-4">
                            <div class="col-md-6">
                                <h2>Education</h2>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="single-progress">
                                    ...
                                    <div class="progress st2">
                                        <div class="progress-bar " data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1000" data-aos-anchor-placement="top bottom" role="progressbar" aria-label="Basic example" style="width: 90%" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>                          
                                </div><!--/.single-progress-->
                            </div>
                            <div class="col-lg-6">
                                <div class="single-progress">
                                    ...
                                    <div class="progress st3">
                                        <div class="progress-bar " data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1000" data-aos-anchor-placement="top bottom" role="progressbar" aria-label="Basic example" style="width: 60%" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>                          
                                </div><!--/.single-progress-->
                                <div class="single-progress">
                                    <label class="d-flex justify-content-between">
                                    ...
                                    <div class="progress st4">
                                        <div class="progress-bar " data-aos="fade-right" data-aos-easing="linear" data-aos-duration="1000" data-aos-anchor-placement="top bottom" role="progressbar" aria-label="Basic example" style="width: 80%" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
                                    </div>                          
                                </div><!--/.single-progress-->
                            </div>
                        </div>
                        ...
                        <p>Chunks as necessary, making this the first true generator on the Internet. It uses a dictionary of over 200 Latin word
                            combined with a handful of model sentence structures, to generate Lorem Ipsum which looks.</p>
                    </div><!--/.right-content-spkrDetails-->
                </div>
            </div>
        </div><!--/.container-->
    </section>
    <!--speakers details page end-->
