                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav mx-auto">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li class="nav-item">
                                            <a href="events.html" class="nav-link active">Event</a>
                                        </li>
                                        <li class="nav-item">
            ...
            <div class="row gy-4">
                <div class="col-12">
                    <div class="sec-title text-center">
                        <h4><img src="img/icon/title-icon.svg" data-aos="flip-left" data-aos-duration="1500" alt=""> Events Schedule 2023</h4>
                ...
                <div class="col-12 mt-0">
                    <ul class="nav nav-tabs schedule-nav align-items-center justify-content-center mt-50" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                          <button class="nav-link" id="eventScheduletab31-tab" data-bs-toggle="tab" data-bs-target="#eventScheduletab3" type="button" role="tab" aria-controls="eventScheduletab3" aria-selected="false">03 Day 08 03 2023</button>
                        </li>
                        <li class="nav-item" role="presentation">
                ...
                <div class="col-12">
                    <div class="tab-content mt-3" id="myTabContent">
                        ...
                        <div class="tab-pane fade show active" id="eventSchedule_tab1" role="tabpanel" aria-labelledby="eventSchedule_tab1-tab">
                            ...
                            <nav class="mt-5">
                                <ul class="pagination justify-content-center flex-wrap blog">
                                  <li class="page-item">
